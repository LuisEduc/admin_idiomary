<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <!-- <x-jet-nav-link href="{{ route('diariopalabras.index') }}" :active="request()->routeIs('diariopalabras.index')">
                        {{ __('Palabras del día') }}
                    </x-jet-nav-link> -->
                    <!-- <x-jet-nav-link href="{{ route('palabras.index') }}" :active="request()->routeIs('palabras.index')">
                        {{ __('Todas las palabras') }}
                    </x-jet-nav-link> -->
                    <x-jet-nav-link href="{{ route('lessons.index') }}" :active="request()->routeIs('lessons.index')">
                        {{ __('Lecciones') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <!-- <x-jet-responsive-nav-link href="{{ route('diariopalabras.index') }}" :active="request()->routeIs('diariopalabras.index')">
                {{ __('Palabras del día') }}
            </x-jet-responsive-nav-link> -->
            <!-- <x-jet-responsive-nav-link href="{{ route('palabras.index') }}" :active="request()->routeIs('palabras.index')">
                {{ __('Todas las palabras') }}
            </x-jet-responsive-nav-link> -->
            <x-jet-responsive-nav-link href="{{ route('lessons.index') }}" :active="request()->routeIs('lessons.index')">
                {{ __('Lecciones') }}
            </x-jet-responsive-nav-link>
